...
Это список изменений, которые могут потребовать вмешательства в виде
правок в скриптах или в вашем окружении разработки. Мы стремимся к тому, чтобы
все остальные изменения не влияли на существующие скрипты.

Обратите внимание, что установка :var:`config.script_version` приведёт к отмене многих из
этих изменений, но ценой потери доступа к новым функциям.

Несовместимые изменения в GUI документированы в разделе :ref:`gui-changes`, так как
такие изменения вступают в силу только при повторной генерации GUI.
